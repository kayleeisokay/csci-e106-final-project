...
As well, P-value of test is 2.2e-16 which is below our alpha of 0.05 , confirming that we should reject $H_0$. Variances are not constant, so normality is still an issue, specifically in the extremes.
...
performance_ridge = cbind(CalcTestMetrics(pred_ridge, act_ridge, n_ridge, p_ridge))
